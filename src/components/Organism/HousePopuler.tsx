...
const HousePopuler: React.FC = () => {
  return (
    <div className="w-full max-w-7xl pb-[50px] px-4 md:px-0 mx-auto">
      <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between mb-7 md:items-end">
        <div className="text-[#3A3A3A]">
          ...
          <p className="mt-[10px] text-lg">
            Properti yang paling banyak dilihat pembeli
          </p>
        </div>
