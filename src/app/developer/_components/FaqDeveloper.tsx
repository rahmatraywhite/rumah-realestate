...
const FaqDeveloper: React.FC = () => {
  return (
    <div className="w-full bg-[#D5D5D533] my-[62px] bg-opacity-[20%] gap-4 py-16 max-w-7xl pt-[65px] px-4 md:px-12 mx-auto">
